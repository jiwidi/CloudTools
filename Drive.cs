...
namespace CloudTools
{
    public class Drive  //CloudDocInterface
    {
        ...
        public static Boolean uploadFile(DriveService service,string filePath, string fileIDparent,string nameFile)
        {
            try
            {
        ...
        /// <param name="parentID"></param>
        /// <returns></returns>
        private static List<CloudObject> getFilesFromParentFirstFloor(DriveService service,string parentID)//shit method bru
        {
